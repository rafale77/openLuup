...
local function jsonify (x) return (json.encode (x.definition, {empty_table_as_array=true})) or '?' end             -- return JSON scene representation
...
local function scene_clone(self)
  ...
  local info = json.encode(desc, {empty_table_as_array=true})          -- make a (json) version of the scene definition
